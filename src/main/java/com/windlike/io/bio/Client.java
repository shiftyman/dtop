...
//                long data = (long)payload;
                ...
                HashLongObjMap<ActivityVo> activityMap = (HashLongObjMap<ActivityVo>) payload;
                output.writeShort(activityMap.size());
                Iterator<ActivityVo> iterator = activityMap.values().iterator();
                while (iterator.hasNext()){
